...
var nodes_1 = require("../src/lib/agent/graph/nodes");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var tests, _i, tests_1, t, state, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    t = tests_1[_i];
                    console.log("\nInput: \"".concat(t.message, "\" -> Expected: ").concat(t.expected));
                    state = {
                        messages: [new messages_1.HumanMessage(t.message)],
                        summary: "",
                        storeId: "test-store",
                        conversationId: "123",
                        customerId: "456",
                    ...
                    return [4 /*yield*/, (0, nodes_1.supervisorNode)(state)];
                case 2:
                    result = _a.sent();
                    console.log("Result: -> ".concat(result.activeAgent));
                    if (result.activeAgent !== t.expected) {
                        console.error("FAILED! Expected ".concat(t.expected, " but got ").concat(result.activeAgent));
                    }
                    else {
                        console.log("PASS!");
                    }
